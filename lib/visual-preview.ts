...
export const visualBookingFixtures = [
  ...
  { id: 'visual-booking-2', status: 'cancelled' as const, trainings: { date: '2026-07-10', start_time: '20:00:00', end_time: '22:00:00', location_name: 'Зал «Ермак»', address: 'ул. Олега Кошевого, 8' } }
];
