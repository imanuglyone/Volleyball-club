...
export default function ProfilePage() {
  ...
  useEffect(() => { setName(profile?.display_name ?? (visualPreview ? 'Иван' : '')); setPhone(profile?.phone ?? (visualPreview ? '+7 900 123-45-67' : '')); }, [profile, visualPreview]);
