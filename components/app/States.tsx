...
export function LoadingState() { return <div className="state-loading" role="status" aria-label="Загрузка" aria-busy="true"><div className="skeleton skeleton--hero"/><div className="skeleton skeleton--line"/><div className="skeleton skeleton--line skeleton--short"/></div>; }
